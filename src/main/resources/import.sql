INSERT INTO tb_user (name, email, password) VALUES ('Caroline Nair da Costa', 'carolinenairdacosta@outllok.com', 'qo7w7BN7wX');
INSERT INTO tb_user (name, email, password) VALUES ('Hugo Vitor Martins', 'hugovitormartins@iclud.com', 'AgZ463qGli');
